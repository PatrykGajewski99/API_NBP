            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                        <form method="get" name="conversion" id="conversion" action="{{route('check.currency.rate')}}">
                            @csrf
                            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                                <div class="grid grid-cols-3 md:grid-cols-2">
                                    <div class="p-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 text-lg leading-7 font-semibold">Date</div>
                                        </div>

                                        <div class="ml-12">
                                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                                <input type="date" id="date" name="date" class="field"  required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                        <div class="flex items-center">
                                            <img src="https://pixsector.com/cache/1549118e/av70a149d5d0f534e7ab0.png" class="img" alt="curreency"/>
                                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com" class="underline text-gray-900 dark:text-white">Currency</a></div>
                                        </div>
                                ...
                                <button class="convert" name="convert" id="convert" >CHECK</button>
                            </div>
                        </form>
